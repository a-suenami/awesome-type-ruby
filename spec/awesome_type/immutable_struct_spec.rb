require 'awesome_type/immutable_struct'

RSpec.describe AwesomeType::ImmutableStruct do
  let(:klass) { AwesomeType::ImmutableStruct.new(:id, :name) }
  ...
  it 'can define any instance methods' do
    klass = AwesomeType::ImmutableStruct.new(:id, :first_name, :last_name) do
      def full_name
